...
public class TestEmployeePredicates {
    public static List<Employee> employeeList = init();
    ...
    public static void main(String[] args){
        ...
        System.out.println(filterEmployees(employeeList, isAgeMoreThan(35)));
        //Employees other than above collection of "isAgeMoreThan(35)" can be get using negate()
        System.out.println(filterEmployees(employeeList, isAgeMoreThan(35).negate()));
    }
